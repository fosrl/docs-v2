...
Use [Install Clients](/manage/clients/install-client) for people logging in with accounts, and [Machine Clients](/manage/clients/manage-machine-clients) for automated systems and servers.
