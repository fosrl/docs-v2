...
Users must log in and connect from a Pangolin client for [Windows, Mac, and Linux](/manage/clients/install-client). Machine (automated systems and servers) connect with an ID and secret.
