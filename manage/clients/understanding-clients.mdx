...
Users must log in and connect from a Pangolin client for [Windows, Mac, or Linux](/manage/clients/install-client). Machines (automated systems and servers) connect with an ID and secret.
