...
Use [Install Clients](/manage/clients/install-client) for people logging in with accounts. Automated systems and servers connect with a client ID and secret instead.
