...
Having trouble connecting or signing in? See [User Device Troubleshooting](/manage/clients/user-device-troubleshooting).
...
<span id="pangolin-cli-linux"></span>
...
<span id="docker-pangolin-cli"></span>

### Docker (Pangolin CLI)

Docker-based CLI usage is documented under machine clients. See [Install Machine Client](/manage/clients/install-machine-client).
