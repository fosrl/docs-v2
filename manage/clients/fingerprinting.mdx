...
<PangolinCloudTocCtaCard
  title="Add Device Posture Signals"
  body="Collect posture data and use device insights to strengthen access decisions in Pangolin Cloud."
  utmContent="client_fingerprinting"
/>
...
<Note>
	Posture checks are only collected on [Pangolin Cloud](https://app.pangolin.net/auth/signup?utm_source=docs&utm_medium=availability_note&utm_campaign=cloud_positioning&utm_content=client_fingerprinting) and self-hosted [Enterprise Edition](/self-host/enterprise-edition).
</Note>
