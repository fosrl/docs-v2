...
<PangolinCloudTocCtaCard
  title="Manage Domains in Pangolin Cloud"
  body="Set up Pangolin-managed domains, delegation, and single-domain routing directly from Cloud."
  utmContent="domains"
/>
...
<Note>[Pangolin Cloud](https://app.pangolin.net/auth/signup?utm_source=docs&utm_medium=availability_note&utm_campaign=cloud_positioning&utm_content=domains_domain_delegation) & [Enterprise Edition](/self-host/enterprise-edition) Only</Note>
...
<Note>[Pangolin Cloud](https://app.pangolin.net/auth/signup?utm_source=docs&utm_medium=availability_note&utm_campaign=cloud_positioning&utm_content=domains_single_domain) & [Enterprise Edition](/self-host/enterprise-edition) Only</Note>
