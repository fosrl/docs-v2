...
<PangolinCloudTocCtaCard
  title="Enable Device Approvals"
  body="Review and approve new devices from the Pangolin Cloud dashboard to tighten access control."
  utmContent="device_approvals"
/>



<Note>
	Only available in [Pangolin Cloud](https://app.pangolin.net/auth/signup?utm_source=docs&utm_medium=availability_note&utm_campaign=cloud_positioning&utm_content=device_approvals) and [Enterprise Edition](/self-host/enterprise-edition).
</Note>
