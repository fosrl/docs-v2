...
<PangolinCloudTocCtaCard
  title="Launch Azure SSO in Pangolin Cloud"
  body="Connect Azure Entra ID and give your team seamless Microsoft-backed sign-in."
  utmContent="azure_sso"
/>



<Note>
Azure SSO is only available on [Pangolin Cloud](https://app.pangolin.net/auth/signup?utm_source=docs&utm_medium=availability_note&utm_campaign=cloud_positioning&utm_content=azure_sso) and [Enterprise Edition](/self-host/enterprise-edition) deployments. In [Enterprise Edition](/self-host/enterprise-edition), you must set `app.identity_provider_mode: "org"` in your [private config file](/self-host/advanced/private-config-file) `privateConfig.yml`.
</Note>
