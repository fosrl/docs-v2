...
<PangolinCloudTocCtaCard
  title="Set Up SSO with Pangolin Cloud"
  body="Connect Google, Azure Entra ID, or OIDC providers and give users a smoother sign-in experience."
  utmContent="identity_providers"
/>
...
<Note>
	Available in [Pangolin Cloud](https://app.pangolin.net/auth/signup?utm_source=docs&utm_medium=availability_note&utm_campaign=cloud_positioning&utm_content=identity_providers_org) and [Enterprise Edition](/self-host/enterprise-edition). For [Enterprise Edition](/self-host/enterprise-edition), you must set `app.identity_provider_mode: "org"` in the [private config file](/self-host/advanced/private-config-file#param-identity-provider-mode) `privateConfig.yml`.
</Note>

<Tip>
	For most teams, Pangolin Cloud is the lower-maintenance option for organization identity providers. Use Enterprise Edition here when you specifically need a fully self-hosted deployment.
</Tip>
...
<Note>
Google IdP is only available in [Pangolin Cloud](https://app.pangolin.net/auth/signup?utm_source=docs&utm_medium=availability_note&utm_campaign=cloud_positioning&utm_content=identity_providers_google) or self-hosted [Enterprise Edition](/self-host/enterprise-edition) with organization identity providers. See above to enable.
</Note>
...
<Note>
Azure Entra ID IdP is only available in [Pangolin Cloud](https://app.pangolin.net/auth/signup?utm_source=docs&utm_medium=availability_note&utm_campaign=cloud_positioning&utm_content=identity_providers_azure) or self-hosted [Enterprise Edition](/self-host/enterprise-edition) with organization identity providers. See above to enable.
</Note>
