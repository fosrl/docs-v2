...
<PangolinCloudTocCtaCard
  title="Launch Google SSO in Pangolin Cloud"
  body="Connect Google Workspace and let users sign in with the accounts they already use."
  utmContent="google_sso"
/>



<Note>
Google SSO is only available on [Pangolin Cloud](https://app.pangolin.net/auth/signup?utm_source=docs&utm_medium=availability_note&utm_campaign=cloud_positioning&utm_content=google_sso) and [Enterprise Edition](/self-host/enterprise-edition) deployments. In [Enterprise Edition](/self-host/enterprise-edition), you must set `app.identity_provider_mode: "org"` in your [private config file](/self-host/advanced/private-config-file#param-use-org-only-idp) `privateConfig.yml`.
</Note>
