...
This guide is for teams evaluating the self-hosted path. If you want the fastest setup or a hosted control plane, review Pangolin Cloud and Remote Nodes before continuing.

<CardGroup cols={2}>
  <Card title="Start with Pangolin Cloud" icon="cloud" href="/cloud/getting-started">
    Choose Cloud if you want the fastest setup and do not want to manage control-plane upgrades, backups, and day-to-day operations.
  </Card>
  <Card title="Use Remote Nodes with Cloud" icon="circle-nodes" href="/manage/remote-node/understanding-nodes">
    Choose Remote Nodes if you want the Cloud control plane but want traffic and SSL termination to stay on servers you control.
  </Card>
</CardGroup>

Continue with this guide if you specifically want:

- A fully self-hosted Pangolin deployment
- Full responsibility for upgrades, backups, DNS, certificates, and operations
- Community Edition or a fully self-managed Enterprise Edition setup
