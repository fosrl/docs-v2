...
<CardGroup cols={2}>
  <Card title="Need Less Operational Overhead?" icon="cloud" href="/cloud/choose-deployment">
    Compare Enterprise Edition with Pangolin Cloud before you commit to operating the full self-hosted control plane.
  </Card>
  <Card title="Want Cloud Management with Your Own Infrastructure?" icon="circle-nodes" href="/manage/remote-node/understanding-nodes">
    Remote Nodes are the hybrid option when you want Cloud management but prefer traffic handling on servers you control.
  </Card>
</CardGroup>
