...
<Card title="Get a License" icon="server" href="https://pangolin.net/pricing">
...
To see pricing tiers for the self-hosted Enterprise Edition for businesses, [click here](https://pangolin.net/pricing). For more on how to purchase a key, see [Purchase a license key](/self-host/purchase-license-key).
