...
<Tip>
If you want Pangolin to manage more of the control-plane complexity for you, compare this fully self-hosted path with [Pangolin Cloud](/cloud/choose-deployment) before continuing.
</Tip>
