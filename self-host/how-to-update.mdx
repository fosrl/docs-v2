...
<Tip>
If minimizing upgrades and control-plane maintenance is more important than fully self-hosting, review [Pangolin Cloud](/cloud/choose-deployment) and [Remote Nodes](/manage/remote-node/understanding-nodes).
</Tip>
