...
<CardGroup cols={2}>
<Card title="Skip the VPS with Cloud" icon="cloud" href="/cloud/getting-started">
  Start with Pangolin Cloud if you do not want to operate the full control plane yourself.
</Card>

<Card title="Use Remote Nodes Instead" icon="circle-nodes" href="/manage/remote-node/understanding-nodes">
  Pick the hybrid model if you want Cloud management but still want traffic and SSL termination on servers you control.
</Card>
</CardGroup>
