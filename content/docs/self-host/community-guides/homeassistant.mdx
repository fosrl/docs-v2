...
<Note>
This is a set of community add-ons and is not officially supported. If you have any issues, please reach out to the [author](https://github.com/Ferdinand99/home-assistant-newt-addon).
</Note>

This Home Assistant add-on allows you to easily run **Newt** or **Pangolin-CLI** directly in Home Assistant.

## Features

- Easy installation via Home Assistant Add-on Store
- Automated setup and execution of the Newt/Pangolin-CLI container
...
- Add the following URL:
  ```
  https://github.com/boomam/home-assistant-addons
  ```
  or
  ```
...
#### Pangolin-CLI
1. Find **Pangolin-CLI** in the list and click **Install**.
