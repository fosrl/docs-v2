...
<Card title="UI">
  ...
  <Frame>
    <img src="/images/create_blueprint.png" alt="Blueprint creation page in the Pangolin dashboard" width="400"/>
  </Frame>
</Card>
...
services:
  pangolin-site:
    ...
    environment:
      ...
      - SITE_ID=h1rbsgku89wf9z3
      - SITE_SECRET=z7g54mbcwkglpx1aau9gb8mzcccoof2fdbs97keoakg2pp5z
      - DOCKER_SOCKET=/var/run/docker.sock
